...
class Minitest::Benchmark < Minitest::Test
  ...
  def assert_performance_constant(threshold = nil, &work); end
  def assert_performance_exponential(threshold = nil, &work); end
  def assert_performance_linear(threshold = nil, &work); end
  def assert_performance_logarithmic(threshold = nil, &work); end
  def assert_performance_power(threshold = nil, &work); end
  ...
  def io; end
  def self.bench_exp(min, max, base = nil); end
  def self.bench_linear(min, max, step = nil); end
...
class Minitest::BenchSpec < Minitest::Benchmark
  ...
  def self.bench_performance_constant(name, threshold = nil, &work); end
  def self.bench_performance_exponential(name, threshold = nil, &work); end
  def self.bench_performance_linear(name, threshold = nil, &work); end
  def self.bench_performance_logarithmic(name, threshold = nil, &work); end
  def self.bench_performance_power(name, threshold = nil, &work); end
